...
echo Levantando servicios con bind mount local...
docker compose --env-file .env -f docker-compose.yml -f docker-compose.bind.yml up -d
if %ERRORLEVEL% NEQ 0 (
...
echo Datos de PostgreSQL en: %cd%\data\postgres
pause
endlocal
